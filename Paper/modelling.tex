...
Having established our $\alpha$-baseline we now turn our attention to the $\beta$-limit. Although we could do a system-wide one we just measure the code to be optimized, this is a tight bound.
...
\caption{Power Optimization Window}
\end{figure}
